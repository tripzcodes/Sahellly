import 'controller/signup_eight_controller.dart';
import 'models/signup_eight_model.dart';
...
class SignupEightPage extends StatelessWidget {
  SignupEightPage({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  SignupEightController controller =
      Get.put(SignupEightController(SignupEightModel().obs));
                  ...
                  Padding(
                      ...
                      child: Column(children: [
                        _buildUserProfile(
                            ...
                            lbl01012414414: "lbl_ahmed_mohsen".tr),
                        SizedBox(height: 47.v),
                        _buildUserProfile(
                            miCallImage: ImageConstant.imgMiCall,
                            lbl01012414414: "lbl_01012414414".tr),
                        SizedBox(height: 47.v),
                        _buildEmail(),
                        SizedBox(height: 47.v),
                        _buildPassword(),
  ...
  Widget _buildUserProfile({
    ...
    required String lbl01012414414,
  }) {
    return Container(
