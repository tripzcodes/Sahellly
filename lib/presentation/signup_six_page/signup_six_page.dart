import 'controller/signup_six_controller.dart';
import 'models/signup_six_model.dart';
...
class SignupSixPage extends StatelessWidget {
  SignupSixPage({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  SignupSixController controller =
      Get.put(SignupSixController(SignupSixModel().obs));
  ...
  /// Section Widget
  Widget _buildSignupButtonEditText() {
    return Obx(() => CustomTextFormField(
        controller: controller.signupButtonEditTextController,
        hintText: "lbl_electronation".tr,
