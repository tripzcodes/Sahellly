import 'controller/signup_unactive_controller.dart';
import 'models/signup_unactive_model.dart';
...
class SignupUnactivePage extends StatelessWidget {
  SignupUnactivePage({Key? key})
      : super(
          key: key,
        );
  ...
  SignupUnactiveController controller =
      Get.put(SignupUnactiveController(SignupUnactiveModel().obs));
  ...
  /// Section Widget
  Widget _buildWoodworker() {
    return Obx(
      () => CustomTextFormField(
        controller: controller.woodworkerController,
