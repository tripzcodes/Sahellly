import 'controller/signup_unactive_two_controller.dart';
import 'models/signup_unactive_two_model.dart';
...
class SignupUnactiveTwoPage extends StatelessWidget {
  SignupUnactiveTwoPage({Key? key})
      : super(
          key: key,
        );
  ...
  SignupUnactiveTwoController controller =
      Get.put(SignupUnactiveTwoController(SignupUnactiveTwoModel().obs));
  ...
  /// Section Widget
  Widget _buildHousePainter() {
    return Obx(
      () => CustomTextFormField(
        controller: controller.housePainterController,
        hintText: "lbl_house_painter".tr,
